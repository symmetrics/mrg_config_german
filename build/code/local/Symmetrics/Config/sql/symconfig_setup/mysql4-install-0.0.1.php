...
('default', 0, 'trans_email/ident_general/name', '${ident_general_name}'),
('default', 0, 'trans_email/ident_general/email', '${ident_general_email}'),
('default', 0, 'trans_email/ident_sales/name', '${ident_sales_name}'),
('default', 0, 'trans_email/ident_sales/email', '${ident_sales_email}'),
('default', 0, 'trans_email/ident_support/name', '${ident_support_name}'),
('default', 0, 'trans_email/ident_support/email', '${ident_support_email}'),
('default', 0, 'trans_email/ident_custom1/name', '${ident_custom1_name}'),
('default', 0, 'trans_email/ident_custom1/email', '${ident_custom1_email}'),
('default', 0, 'trans_email/ident_custom2/name', '${ident_custom2_name}'),
('default', 0, 'trans_email/ident_custom2/email', '${ident_custom2_email}'),
