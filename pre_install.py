...
def main(config_module, info_py):
    ...
    content = _replace_in_text(content, {
        ...
        'email_general': magento['contact_addresses']['general']['email'],
        'email_sales': magento['contact_addresses']['sales']['email'],
        'email_support': magento['contact_addresses']['support']['email'],
        'email_custom1': magento['contact_addresses']['custom1']['email'],
        'email_custom2': magento['contact_addresses']['custom2']['email'],
